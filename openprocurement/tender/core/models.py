...
class Question(Model):
    ...
    id = MD5Type(required=True, default=lambda: uuid4().hex)
    author = ModelType(BusinessOrganization, required=True)  # who is asking question (contactPoint - person, identification - organization that person represents)
...
class Complaint(Model):
    ...
    relatedLot = MD5Type()
    # complainant
    author = ModelType(BusinessOrganization, required=True)  # author of claim
